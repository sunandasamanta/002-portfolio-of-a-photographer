  ...
  return (
    <main className="relative min-h-screen">
      ...
      <div className="flex w-full xs:flex-wrap">
        <Image className="xs:p-8 xs:pt-0 min-w-[300px]" src={sadhuBaba2} alt="Sadhu Baba 2"/>
        <Image className="xs:p-8 xs:pt-0 min-w-[300px]" src={pathik} alt="Pathik" />
        <Image className="xs:p-8 xs:pt-0 min-w-[300px] md:hidden" src={sadhuBaba} alt="Sadhu Baba" />
      </div>
